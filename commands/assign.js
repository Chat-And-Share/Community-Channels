...
exports.run = (bot, message, args, tools) => {
  ...
  if (!member) {
    const embed = new Discord.MessageEmbed().setTitle("Please mention a user after the command.");
  ...
  const embed = new Discord.MessageEmbed().setColor(0x1db954).setTitle(`Successfully set ${member.user.username} as the owner of this channel.`);
