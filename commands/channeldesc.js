...
exports.run = async (bot, message, args, tools) => {
  ...
  if (!args[0]) {
    const embed = new Discord.MessageEmbed().setTitle("Please input text following the command.");
  ...
  const embed = new Discord.MessageEmbed().setTitle(`Channel description successfully set to: ${callback.topic}`);
