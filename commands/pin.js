...
exports.run = async (bot, message, args, tools) => {
  ...
  if (!msg || !args[0]) {
    const embed = new Discord.MessageEmbed().setTitle("Please input a messageID following the command.");
  ...
  const embed = new Discord.MessageEmbed().setTitle(`Successfully pinned message.`);
