...
exports.run = async (bot, message, args, tools) => {
  ...
  if (moderators !== null && !moderators.includes(member.id)) {
    const embed = new Discord.MessageEmbed().setTitle("This member is not a moderator.");
  ...
  const embed = new Discord.MessageEmbed().setTitle(`Successfully removed ${member.user.username} as a moderator.`);
